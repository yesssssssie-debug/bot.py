...
def init_database():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS user_points (user_id INTEGER PRIMARY KEY, points INTEGER DEFAULT 0, bot_days INTEGER DEFAULT 0, expiry_date TEXT)''')
